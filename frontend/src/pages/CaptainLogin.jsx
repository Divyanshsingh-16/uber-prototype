...
/>
<button className='bg-[#111] text-white font-semibold mt-4 mb-3 rounded px-4 py-2 border w-full text-lg placeholder:text-base '>login</button>
<p className='text-center'>join as a Captain? <Link  to='/captain-signup'className='text-blue-600' >Register as a Captain</Link> </p>
</form>
    </div>

    <div>
      <Link to='/login' className='bg-[#db622d] flex items-center justify-center text-white font-semibold  mb-5 rounded px-4 py-2 border w-full text-lg placeholder:text-base '>Sign in as  a User</Link>
    </div>
